...
const AnimatedPizza = () => {
  return (
    <div className="bg-red-500 h-screen flex flex-col md:flex-row md:justify-between  md:bg-[url('/bg-pizza.jpg')] md:h-[70vh] object-cover">
     {/* ANIMATION CONTAINER */}
     <div className="flex-1 w-full justify-center content-center relative md:h-full">
      <Lottie animationData={animationData} className='w-3/4 mb-2 relative md:h-full'/>
    </div>
    
    {/* TEXT CONTAINER */}
    <div className="flex-1 flex flex-col justify-center items-center text-center gap-8 p-6">
      <h1 className="text-white text-5xl font-bold xl:text-6xl">Ours Delicious Pizza</h1>
