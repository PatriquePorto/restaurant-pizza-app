    ...
    <footer className="bg-white">
      <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
        <div className="text-center">
          <h2 className="text-3xl font-extrabold text-red-500 sm:text-5xl">
            Pizza Massimo Taste
          </h2>

          <p className="mx-auto mt-4 max-w-sm text-red-500">
          Elevate your pizza experience today. Thank you for choosing Pizza Massimo Taste – where every bite is a celebration of taste!"
          </p>
